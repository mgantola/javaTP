...
CREATE TABLE `personas` (
  ...
  CONSTRAINT `personas_fk1` FOREIGN KEY (`id_tipo_persona`) REFERENCES `tipo_persona` (`id_tipo_persona`)
)ENGINE=InnoDB
CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `servicios` (
  `nro_reserva` INTEGER(4) NOT NULL,
  ...
  CONSTRAINT `servicios_fk1` FOREIGN KEY (`tipo_DNI`, `nro_DNI`) REFERENCES `personas` (`tpo_DNI`, `nro_DNI`),
